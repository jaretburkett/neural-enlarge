...
ALIAS_COMMAND="alias enlarge='function ne() { docker run --rm -v \"\$(pwd)/\`dirname \${@:\$#}\`\":/ne/input -v \"${NEURAL_ENLARGE_PATH}\":/ne -it jaretburkett/neural-enlarge \${@:1:\$#-1} \"input/\`basename \${@:\$#}\`\"; }; ne'"
