...
1.  [Examples & Usage](#1-examples--usage)
...
Here's a list of currently supported models, image types, and zoom
levels in one table.
...
After this, you should have `pillow`, `theano` and `lasagne` installed
